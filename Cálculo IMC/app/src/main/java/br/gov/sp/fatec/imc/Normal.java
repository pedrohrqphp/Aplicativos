...
public class Normal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button voltar = findViewById(R.id.button5);
        ...
        TextView textoIMC = findViewById(R.id.textView12);
        textoIMC.setText(String.format("%.2f", imc));

        TextView textoAltura = findViewById(R.id.textView15);
        textoAltura.setText(String.format("%.2f", altura));

        TextView textoPeso = findViewById(R.id.textView17);
